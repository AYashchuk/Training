 ...
 */
public class СlientThread extends Thread implements AutoCloseable{


    private ServerRun mainServer = ServerRun.getInstance();
    private СlientThread connectOn;
    ...
    public void setConnectOn(СlientThread connectOn) {
        this.connectOn = connectOn;
    }
    public СlientThread(Socket soc, int id){
        this.client = soc;
        try {
